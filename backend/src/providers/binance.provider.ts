  ...
  extends BaseProvider
{
  ...
  async chargeWithAuthorization(
    ...
    throw new Error(
      "Binance authorization charging is not supported in this backend integration.",
    );
  }
  ...
  async createWithdrawal(
    ...
    throw new Error(
      "Binance fiat withdrawals are not supported in this backend integration.",
    );
  }
  ...
  async verifyWithdrawal(
    ...
    throw new Error(
      "Binance fiat withdrawal verification is not supported in this backend integration.",
    );
  }
